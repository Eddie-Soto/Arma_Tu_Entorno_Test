...
foreach($_SESSION['products_checkout'] as $posicion => $products)
{
	...
	//$product_details=.$product_details.$product_detail."&".$quantity_detail."&";
...
if($kit_abi == 1)
{
	echo "https://nikkenlatam.com/services/checkout/testredirect.php?app=pruebas&data=$data";
}
else
{
	//echo "https://nikkenlatam.com/services/checkout/redirect.php?app=armatuentorno&data=$data";
	echo "https://nikkenlatam.com/services/checkout/testredirect.php?app=armatuentorno&data=$data";
}
