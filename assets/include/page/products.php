...

{
	...
	$sql = mysqli_query($conn, "SELECT T0.sku, T0.imagen, T0.nombre_original_producto, T0.puntos,
	    ...
	    IFNULL((SELECT H0.vc_sugerido FROM control_art_test H0 WHERE H0.pais = T0.pais and H0.sku = CONCAT(CASE WHEN REPLACE(T0.sku, 'M', '') = '13501' THEN '135011' WHEN REPLACE(T0.sku, 'M', '') = '1359' THEN '13591' ELSE REPLACE(T0.sku, 'M', '') END, $insert_case as vc_entorno,

	    IFNULL((SELECT H0.vc_sugerido FROM control_art_test H0 WHERE H0.pais = T0.pais and H0.sku = CONCAT(CASE WHEN REPLACE(T0.sku, 'M', '') = '13501' THEN '135011' ELSE REPLACE(T0.sku, 'M', '') END, $insert_case_full as vc_full,

	    T0.precio_sugerido,

	    IFNULL((SELECT H0.precio_sugerido FROM control_art_test H0 WHERE H0.pais = T0.pais and H0.sku = CONCAT(CASE WHEN REPLACE(T0.sku, 'M', '') = '13501' THEN '135011' WHEN REPLACE(T0.sku, 'M', '') = '1359' THEN '13591' ELSE REPLACE(T0.sku, 'M', '') END, $insert_case as precio_entorno,

	    IFNULL((SELECT H0.precio_sugerido FROM control_art_test H0 WHERE H0.pais = T0.pais and H0.sku = CONCAT(CASE WHEN REPLACE(T0.sku, 'M', '') = '13501' THEN '135011' ELSE REPLACE(T0.sku, 'M', '') END, $insert_case_full as precio_full,
	    ...
	    IFNULL((SELECT H0.menudeo FROM control_art_test H0 WHERE H0.pais = T0.pais and H0.sku = CONCAT(CASE WHEN REPLACE(T0.sku, 'M', '') = '13501' THEN '135011' WHEN REPLACE(T0.sku, 'M', '') = '1359' THEN '13591' ELSE REPLACE(T0.sku, 'M', '') END, $insert_case as menudeo_entorno,

	    IFNULL((SELECT H0.menudeo FROM control_art_test H0 WHERE H0.pais = T0.pais and H0.sku = CONCAT(CASE WHEN REPLACE(T0.sku, 'M', '') = '13501' THEN '135011' ELSE REPLACE(T0.sku, 'M', '') END, $insert_case_full as menudeo_full,

	    (SELECT H0.sku FROM control_art_test H0 WHERE H0.pais = T0.pais and H0.sku = CONCAT(CASE WHEN REPLACE(T0.sku, 'M', '') = '13501' THEN '135011' WHEN REPLACE(T0.sku, 'M', '') = '1359' THEN '13591' ELSE REPLACE(T0.sku, 'M', '') END, $insert_case_code as codigo_entorno,

	    (SELECT H0.sku FROM control_art_test H0 WHERE H0.pais = T0.pais and H0.sku = CONCAT(CASE WHEN REPLACE(T0.sku, 'M', '') = '13501' THEN '135011' ELSE REPLACE(T0.sku, 'M', '') END, $insert_case_code_full as codigo_full
		...
		<div class="col-lg-3 col-md-4 col-sm-6" id="product-<?php echo $code_product ?>">
		    ...
		    <div class="col-item">
		        ...
		        <div class="photo">
		        	...
		        	<button class="close" onclick="Delete_product('<?php echo $code_product ?>')" data-toggle="tooltip" data-placement="left" title="Eliminar" <?php if($code_product == "5031" || $code_product == "14412"){ ?> style="display: none;" <?php } ?>><i class="color-green fa fa-times-circle" aria-hidden="true"></i></button>
