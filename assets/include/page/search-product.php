...
elseif($product == "KENKO SLEEP FUKAI"){
	...
	// $insert_product = "(sku in ('13651','136518')) AND ";
	$insert_product = "(sku in ('12240','12250')) AND ";
}
...
FROM
    ...
    control_art_test T0 INNER JOIN control_iva T1 ON T0.pais = T1.pais INNER JOIN control_marcas T2 ON T0.marca = T2.idcontrol_marcas
