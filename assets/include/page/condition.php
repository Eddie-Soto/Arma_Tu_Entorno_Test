...
?>
...

		{
			...
			<div class="col-lg-4 col-sm-6 col-xs-6 col-md-6"><div style="cursor: pointer;"><img src="img/environment/PetPad_EntornoB.png" onclick="Send_product_search('KENKO SLEEP PET PAD')" class="img-responsive center-block" alt="KENKO SLEEP PET PAD"><span class="help-block text-environment">Kenko Sleep Pet Pat</span></div></div>
...

{
	...
	<h2>Condición mínima para <strong>Armar tu entorno Little Steps</strong><span tabindex="0" role="button" data-html="true" data-toggle="popover" data-trigger="focus" data-placement="bottom"
	...
	<p class="help-block padding-bottom"><small><i class="color-green fa <?php if(Valite_littlesteps_environment_one() == 0){ echo "fa-circle-o"; }else{ echo "fa-check-circle-o";  } ?> fa-2x" aria-hidden="true"></i>&nbsp;&nbsp;<strong><span class="color-green">1°</span> Escoge al menos 5 unidades.</strong></small><br/><span style="font-size: 15px;"><small><u>Ten en cuenta que los productos adicionales que no pertenezcan a la promoción,<strong> no aplican para el obsequio especial</strong></u></small></span></p>
...

{
	...
	<p class="help-block padding-bottom"><small><i class="color-green fa <?php if(Valite_escolar_environment_two() == 0){ echo "fa-circle-o"; }else{ echo "fa-check-circle-o"; } ?> fa-2x" aria-hidden="true"></i>&nbsp;&nbsp;<strong><span class="color-green">2°</span> Escoge uno de los siguientes productos</strong></small></p>
		...
		<div class="row">
			...
			<div class="col-lg-4 col-sm-6 col-xs-6 col-md-6"><div style="cursor: pointer;"><img src="img/environment/spiral_tech_band_escolar.png" onclick="Send_product_search('KENKO FASHION SPIRAL TECH BAND')" class="img-responsive center-block" alt="Spiral"><span class="help-block text-environment">Spiral</span></div></div>
...
?>
		...
		<div class="form-group">
			...
			<div class="row">
				...
				<div class="col-lg-4 col-sm-4 col-xs-4 col-md-4" ><div style="cursor: pointer;" data-toggle="modal" data-target="#modal-kenko-fashion"><img src="img/environment/personal-7.png" onclick="Send_product_search('KENKO FASHION')" class="img-responsive center-block" alt="KENKO FASHION"></div></div>
				...
				<div class="col-lg-4 col-sm-4 col-xs-4 col-md-4" <?php if($country_abi == 10){ ?>style="display: none;"<?php } ?> ><div style="cursor: pointer;"><img src="img/environment/personal-4.png" onclick="Send_product_search('TRUE ELEMENTS')" class="img-responsive center-block" alt="TRUE ELEMENTS"></div></div>
...
<!-- SE AGREGA PARA COL EL ITEM 2515 24/02/2021 -->
				...
				<div class="col-lg-4 col-sm-4 col-xs-4 col-md-4" <?php if($country_abi == 6 || $country_abi == 7 || $country_abi == 8 || $country_abi == 10){ ?>style="display: none;"<?php } ?>><div style="cursor: pointer; height: 215px;"><img src="img/environment/Jade.png" width="189" height="189" onclick="Send_product_search('KENZEN JADE GREENZYMES CITRUS - FRASCO')" class="img-responsive center-block" alt="15581"><span class="help-block text-environment">Kenzen Jade Greenzymes Citrus</span></div></div>
