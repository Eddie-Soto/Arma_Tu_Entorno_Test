	...
	<div class="modal-dialog modal-lg">
		...
		<div class="modal-content brands-kenko-fashion">
			...
			<div class="modal-body center-block text-center">
				...
				<div style="cursor: pointer; display: inline-block;" data-dismiss="modal"><img src="img/brands-kenko-fashion/hoshi.png" onclick="Send_product_search('HOSHÍ')" alt="VENUS"></div>

				<div style="cursor: pointer; display: inline-block;" data-dismiss="modal"><img src="img/brands-kenko-fashion/marui.png" onclick="Send_product_search('MARUI')" alt="VENUS"></div>

<?php if($country_abi != 10){ ?>
				<div style="cursor: pointer; display: inline-block;" data-dismiss="modal"><img src="img/brands-kenko-fashion/bikubi.png" onclick="Send_product_search('BIKUBI')" alt="VENUS"></div>
<?php } ?>

				<div style="cursor: pointer; display: inline-block;" data-dismiss="modal"><img src="img/brands-kenko-fashion/musubi.png" onclick="Send_product_search('MUSUBI')" alt="VENUS"></div>
...
<?php } ?>
				<div style="cursor: pointer; display: inline-block;" data-dismiss="modal"><img src="img/brands-kenko-fashion/b_shine.png" onclick="Send_product_search('BSHINE')" alt="B-SHINE"></div>
				...
				<div style="cursor: pointer; display: inline-block;" data-dismiss="modal"><img src="img/brands-kenko-fashion/logo-nova-Ring-ATE.png" onclick="Send_product_search('19172')" alt="KENKO FASHION NOVA RING"></div>
